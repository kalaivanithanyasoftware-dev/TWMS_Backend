...
const performCycleCountActions = async (req, res) => {
    ...
    try {
        ...
        if (['AddCycleCount', 'Delete'].includes(action)) {
            if (error) {
        ...
        if (['ReelsStatusList', 'LocationList'].includes(action)) {
...
export { performCycleCountActions }