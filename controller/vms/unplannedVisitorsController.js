...
const performUnplannedVisitorAction = async (req, res) => {
    ...
    try {
        ...
        if (['Add', 'Update', 'Upload', 'Delete', 'CheckIn', 'CheckOut'].includes(action)) {
            if (error) {
